...
#ifndef OPENMOUNTAINDUCKCORE_SWIFT_H
#define OPENMOUNTAINDUCKCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OpenMountainDuckCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20OpenMountainDuckCore22FileProviderEnumerator")
...
SWIFT_CLASS_NAMED("FileProviderExtension")
...
- (NSProgress * _Nonnull)modifyItem:(NSFileProviderItem _Nonnull)item baseVersion:(NSFileProviderItemVersion * _Nonnull)baseVersion changedFields:(NSFileProviderItemFields)changedFields contents:(NSURL * _Nullable)newContents options:(NSFileProviderModifyItemOptions)options request:(NSFileProviderRequest * _Nonnull)request completionHandler:(void (^ _Nonnull)(NSFileProviderItem _Nullable, NSFileProviderItemFields, BOOL, NSError * _Nullable))completionHandler SWIFT_WARN_UNUSED_RESULT;
- (NSProgress * _Nonnull)deleteItemWithIdentifier:(NSFileProviderItemIdentifier _Nonnull)identifier baseVersion:(NSFileProviderItemVersion * _Nonnull)baseVersion options:(NSFileProviderDeleteItemOptions)options request:(NSFileProviderRequest * _Nonnull)request completionHandler:(void (^ _Nonnull)(NSError * _Nullable))completionHandler SWIFT_WARN_UNUSED_RESULT;
...
@class NSNumber;
@class NSDate;
/// Bridge representation conforming to Apple’s <code>NSFileProviderItem</code> protocol for Finder presentation.
SWIFT_CLASS("_TtC20OpenMountainDuckCore16FileProviderItem")
